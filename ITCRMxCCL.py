...
#ITCRM
# Si es primera descarga abajo va => /ITCRMSerie.xls" sin el (2)
...
# Si es primera descarga abajo va => /com3500.xls" sin el (40)
...
ratio["ratio_ccl"] = ratio["CCL"]/ratio["CCL"].loc["2019-08-29"]
ratio["ratio_dlr"] = ratio["dlr"]/ratio["dlr"].loc["2019-08-29"]
ratio["ratio_total"] = ratio["ratio_ccl"] / ratio["ratio_dlr"]
